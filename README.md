...
Local-only bookmarklet to estimate how many Amazon.de physical orders/delivery groups you had in the last 365 days, and what a €2-per-parcel tax would cost.
...
It also counts visible `.delivery-box` elements as a rough shipment/delivery-group proxy.
...
- Amazon DOM changes can break the scan.
